...
user_input_code_ss = sc.transform(user_input_code)
# ss = StandardScaler()
# user_input_code_ss = pd.DataFrame(ss.fit_transform(user_input_code), columns=ss.get_feature_names_out())
...
with st.spinner('Predicting...'):
    time.sleep(2)
    prediction = round(gs.predict(user_input_code_ss)[0])
